...
//L.Filter.DWithin = L.Filter.extend({
//append: function(geometryLayer, geometryField, crs) {
//  var intersectsElement = L.XmlUtil.createElementNS('ogc:Contains');
//  intersectsElement.appendChild(L.XmlUtil.createElementNS('ogc:PropertyName', {}, { value: geometryField }));
//  intersectsElement.appendChild(geometryLayer.toGml(crs));
//  //intersectsElement.appendChild(L.XmlUtil.createElementNS('ogc:Distance', {units:'m'}, { value: geometryLayer.getRadius() }));
//  this.filter.appendChild(intersectsElement);
//
//  return this; 
//}
...
//  var distance=L.XmlUtil.createElementNS('ogc:Distance', {units: 'm'}, {value: this.getRadius()});
//  var node = L.XmlUtil.createElementNS('', {});
