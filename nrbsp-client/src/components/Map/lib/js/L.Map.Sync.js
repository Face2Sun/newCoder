...
(function () {
    ...
    L.Map = L.Map.extend({
        ...
        unsync: function (map) {
            ...
            this.off('zoomend', this._zoomEndListener, this);
            this.off('dragend', this._dragEndListener, this);
        ...
        _initSync: function () {
            ...
            originalMap.on('zoomend', this._zoomEndListener, this);

            originalMap.on('dragend', this._dragEndListener, this);
